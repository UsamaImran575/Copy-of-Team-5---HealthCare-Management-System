<%@page import="com.health.data.Rating"%>
                    ...
                    <div class="bradcam_text">
                        ...
                        <p>
                            ...
                            Doctor D=(Doctor)session.getAttribute("currentUser"); 
                                   String nam1=D.getName();
                                   
                                   float a= D.getRate_Value();
                                   String S2= D.get_Specializtion();                                  
                                   out.print("Name :   ");
                                   out.print(nam1);
                                    out.print("<br>");
                                    out.print("Specializtion :  ");
                                   out.print(S2);
                                   out.print("<br>");
                                    out.print("Rating :   ");
                                   out.print(a);
                                   out.print("<br>");
                                   out.print("<br>");
                                   out.print("Recent Reviews:");
                                   out.print("<br>");
                                   ArrayList<String> temp= D.get_Review();
