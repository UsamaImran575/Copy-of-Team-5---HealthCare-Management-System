<%-- 
    Document   : history
    Created on : Apr 13, 2020, 2:06:18 AM
    Author     : HP
--%>

<%@page import="com.health.data.History"%>
                                ...
                                <nav>
                                    <ul id="navigation">
                                       <li><a href="index.jsp">Home</a></li>
                                        ...
                                        <li><a class="active" href="history.jsp">History</a>
                                        </li>
...
<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Your Were Diagnosed with </h3>

<ul>
    <%
         Patient p=(Patient)session.getAttribute("currentUser");
       ArrayList<History> ab=p.get_History();
        for(int i=0;i<ab.size();i++)
        {
        %>
        
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=ab.get(i).getName()%> &nbsp;&nbsp;&nbsp;&nbsp<%=ab.get(i).getDate()%>  </li>
  <%
      }
      %>
</ul>  
